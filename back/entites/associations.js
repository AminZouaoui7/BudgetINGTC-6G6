...
User.hasMany(Category, { foreignKey: "userId", onDelete: "SET NULL" });
Category.belongsTo(User, { foreignKey: "userId", onDelete: "SET NULL" });
//user own many budgets
User.hasMany(Budget, { foreignKey: "ownerId", onDelete: "CASCADE", as: "ownedBudgets" });
Budget.belongsTo(User, { foreignKey: "ownerId", as: "owner" });
...
BudgetMember.belongsTo(User,       { foreignKey: "userId",      as: "user" })
User.hasMany(BudgetMember,         { foreignKey: "userId",      as: "budgetMemberships" })
